...
- `../../js/research-dmem-observation.js` validates imported, raw-address-free DMEM0 research classifications. It does not access devices.
...
- No kernel offsets, guessed bases, raw addresses, device access, arbitrary syscalls, or GoldHEN loading.
