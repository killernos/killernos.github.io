...
assert.equal(buildObservationArtifact(snapshot({events:[{stage:'NEXT-1302-HARDWARE-CONFIRMED',sessionId:'NEXT-SESSION-test-13'}]})).ok,false);
assert.equal(buildObservationArtifact(snapshot({events:[{stage:'NEXT-1302-HARDWARE-CONFIRMED',sessionId:'NEXT-SESSION-test-13'},{stage:'NEXT-1302-SESSION-COMPLETED',sessionId:'NEXT-SESSION-test-13'},{stage:'LATE',sessionId:'NEXT-SESSION-test-13'}]})).ok,false);
