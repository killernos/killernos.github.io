...
assert.match(runtimeHtml, /userland-probe\.js\?v=next-universal-1302-1352-research-0015/);
assert.match(probe, /core\.js\?v=10/);
assert.match(probe, /research-state\.js\?v=next-universal-1302-1352-research-0015/);
assert.match(probe, /research-adapter\.js\?v=next-universal-1302-1352-research-0015/);
...
assert.doesNotMatch(diagnostics, /observedResearch = sessionHasStage\([^\n]+READ-PRIMITIVE-PASS/);
assert.match(diagnostics, /report\.diagnostics = state\.includeDiagnostics \? sessionRecords : \[\]/);
